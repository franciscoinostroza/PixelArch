    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          navbarMobileMenuRow: { background: "#14142a", borderBottom: "1px solid rgba(255,255,255,0.06)" },
          navbarMobileMenuButton: { color: "#f1f5f9" },
          navbarMobileMenuButtonIcon: { color: "#94a3b8" },
          profileSection: {
            padding: "1.5rem",
            borderBottom: "1px solid rgba(255,255,255,0.06)",
          },
          profileSectionItemList: { gap: "2px" },
          profileSectionItem: {
            padding: "0.625rem 0",
            borderBottom: "1px solid rgba(255,255,255,0.04)",
            "&:last-child": { borderBottom: "none" },
          },
          profileSectionHeader: { marginBottom: "0.5rem" },
          ...
          userPreviewAvatarIcon: { color: "#535a66" },
          userPreviewTextContainer: { gap: "0.25rem" },
          userPreviewMainIdentifier: { color: "#f1f5f9", fontWeight: 600, fontSize: "0.9375rem" },
          ...
          avatarImage: { borderRadius: "9999px" },
          avatarImageActions: { gap: "0.5rem", marginTop: "0.75rem" },
          avatarImageActionsUpload: {
            ...
            cursor: "pointer",
            transition: "all 0.2s",
            "&:hover": { background: "rgba(127,90,240,0.2)" },
          },
          ...
          form: { gap: "1rem" },
          formContainer: { background: "transparent" },
          formFieldRow: { gap: "1rem" },
          formField: { gap: "0.25rem" },
          formFieldLabelRow: { marginBottom: "0.25rem" },
          formFieldWarningText: { color: "#f59e0b", fontSize: "0.75rem" },
          formFieldInfoText: { color: "#64748b", fontSize: "0.75rem", fontStyle: "italic" },
          formFieldHintText: { color: "#64748b", fontSize: "0.75rem" },
          formButtonReset: {
            background: "rgba(255,255,255,0.04)",
            color: "#94a3b8",
            border: "1.5px solid rgba(255,255,255,0.08)",
          ...
          switchRoot: { gap: "0.75rem" },
          switchIndicator: {
            background: "rgba(255,255,255,0.1)",
            borderRadius: "9999px",
            width: "2.5rem",
            height: "1.5rem",
            "&[data-checked]": { background: "#7f5af0" },
          },
          switchThumb: {
            background: "#f1f5f9",
            borderRadius: "9999px",
          ...
          switchLabel: { color: "#f1f5f9", fontSize: "0.875rem", fontWeight: 500 },
          modalBackdrop: {
