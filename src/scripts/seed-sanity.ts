  ...
  const servicios = [
    {
      ...
      descripcion:
        "Creamos aplicaciones web modernas, rápidas y escalables con React, Next.js y TypeScript. Desde landings institucionales hasta dashboards complejos, cada proyecto se adapta a las necesidades de tu negocio.",
      icono: "🌐",
    ...
    },
    {
      ...
      descripcion:
        "Automatizá la atención al cliente y las ventas con chatbots inteligentes que funcionan en WhatsApp, Telegram, Instagram y tu sitio web. Entrenados con tu información y conectados a tus sistemas.",
      icono: "🤖",
    ...
    },
    {
      ...
      descripcion:
        "Desplegamos agentes de inteligencia artificial autónomos que analizan datos, toman decisiones y ejecutan tareas complejas. Ideales para soporte, análisis de documentos, clasificación y más.",
      icono: "🧠",
      tags: ["GPT", "LangChain", "RAG", "Autónomo", "Análisis"],
      orden: 3,
      activo: true,
    },
    {
      ...
      descripcion:
        "Landing pages diseñadas para convertir. Optimizadas para SEO, velocidad de carga y dispositivos móviles. Incluyen analíticas, formularios de contacto y A/B testing.",
      icono: "🎯",
      tags: ["SEO", "Conversión", "Rápido", "Responsive", "Analytics"],
      orden: 4,
      activo: true,
    },
    {
      ...
      descripcion:
        "Conectamos tus herramientas y eliminamos tareas repetitivas con flujos de trabajo automatizados. Integraciones con CRM, email marketing, facturación, notificaciones y más.",
      icono: "⚡",
