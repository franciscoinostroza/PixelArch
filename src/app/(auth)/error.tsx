...
export default function AuthError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4">
      <span className="text-red-500 font-mono text-sm mb-4">Error de autenticacion</span>
      ...
      <p className="text-muted text-center max-w-md mb-8 font-mono text-sm">
        Ocurrio un error en el proceso de autenticacion. Intenta de nuevo o contactanos.
      </p>
      <button
        onClick={reset}
